/* Generated By:JavaCC: Do not edit this line. NJSONParserTokenManager.java */
/*
...
private int jjMoveNfa_0(int startState, int curPos)
{
   ...
   for (;;)
   {
      ...
      if (curChar < 64)
      {
         ...
         do
         {
            int tmp = jjstateSet[--i];
            RLogger.debug(NJSONParserTokenManager.class,"switch(jjstateSet[--i])" , "i=" + i + ",startsAt="+ startsAt  + ",curChar="+ curChar + ",jjstateSet[--i]=" + tmp);
            ...
            switch(tmp)
            {
               case 0:
                  if ((0x3ff000000000000L & l) != 0L)
                  {
                     if (kind > 28)
                        kind = 28;
                     RLogger.debug(NJSONParserTokenManager.class,"switch(jjstateSet[--i])" ,"Matched Symbol");
                     jjCheckNAdd(15);
                  }
...
/** Constructor. */
public NJSONParserTokenManager(JavaCharStream stream){
...
/** Constructor. */
public NJSONParserTokenManager(JavaCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}

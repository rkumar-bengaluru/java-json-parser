...
public class NJSONParser implements NJSONParserConstants {


    private boolean nativeNumbers = false;

    public NJSONParser(String input) {
  ...
  public NJSONParserTokenManager token_source;
  ...
  public NJSONParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public NJSONParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new JavaCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new NJSONParserTokenManager(jj_input_stream);
    token = new Token();
  ...
  /** Constructor. */
  public NJSONParser(java.io.Reader stream) {
  ...
  public NJSONParser(NJSONParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    token.next = jj_nt = token_source.getNextToken();
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(NJSONParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    token.next = jj_nt = token_source.getNextToken();
    jj_gen = 0;

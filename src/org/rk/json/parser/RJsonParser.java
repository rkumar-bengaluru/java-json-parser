...
public class RJsonParser implements RJsonConstants {
     ...
     */
    public java.util.LinkedHashMap<String, Object> parseObject() throws RJsonException {
     ...
     */
    public java.util.ArrayList<Object> parseArray() throws RJsonException {
  ...
  final public String objectKey() throws RJsonException {
    Object o;
    String key;
    switch (jj_nt.kind) {
    case STRING_SINGLE_EMPTY:
  ...
  final public Object value() throws RJsonException {
    Object x;
    switch (jj_nt.kind) {
    case STRING_SINGLE_EMPTY:
    case STRING_DOUBLE_EMPTY:
  ...
  final public Object nullValue() throws RJsonException {
    jj_consume_token(NULL);
      {if (true) return null;}
    throw new Error("Missing return statement in function");
  }

  final public Boolean booleanValue() throws RJsonException {
    Boolean b;
    switch (jj_nt.kind) {
    case TRUE:
  ...
  final public Number number() throws RJsonException {
    RToken t;
    switch (jj_nt.kind) {
    case NUMBER_DECIMAL:
      t = jj_consume_token(NUMBER_DECIMAL);
            if (nativeNumbers) {
                {if (true) return Long.valueOf(t.image);}
            } else {
                {if (true) return new java.math.BigDecimal(t.image);}
            }
      break;
    case NUMBER_INTEGER:
  ...
  final public String string() throws RJsonException {
    String s;
    switch (jj_nt.kind) {
    case STRING_DOUBLE_EMPTY:
    case STRING_DOUBLE_NONEMPTY:
  ...
  final public String doubleQuoteString() throws RJsonException {
    switch (jj_nt.kind) {
    case STRING_DOUBLE_EMPTY:
  ...
  final public String singleQuoteString() throws RJsonException {
    switch (jj_nt.kind) {
    case STRING_SINGLE_EMPTY:
  ...
  final public String symbol() throws RJsonException {
